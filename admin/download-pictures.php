            ...
            <div class="card">
              ...
              <div class="example">
                <a href="../register.php" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
                  ...
                  <a href="download-all.php" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a type="button" href="download-voting-pics.php<?php echo '?id='.$id;?>" class="btn btn-primary btn-lg btn-icon-text">
