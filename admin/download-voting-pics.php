...
include('../dbcon.php');
$category_id = $_GET['id'];
$sql_query = "SELECT * FROM audition WHERE id= '".$category_id."'";
    ...
    <div class="outer">
            ...
            <div style="position:relative; margin-top:-50px;">
             <div style="height:450px; width:170px;margin-top:113px;margin-left:170px;border-width:40px;border-color:green" >
              ...
              <h3 style="font-size:20px;color:white;margin-left:70px;margin-top:-50px;position:absolute;">NAME: <?php echo  strtoupper($row['nickname']);?></h3> 

                <h3 style="font-size:20px;color:white;margin-left:110px;margin-top:-15px;position:relative;"><?php echo $row['style_genre'];?></h3> 
